      ...
      <div className="bg-[#0E6C4F] px-6 py-4">
        <div className="w-full max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="flex gap-4 mb-4 md:mb-0">
            <a href="#"><img src="/src/assets/facebook.png" alt="Facebook" className="w-6 h-6" /></a>
            <a href="#"><img src="/src/assets/instagram.png" alt="Instagram" className="w-6 h-6" /></a>
            <a href="#"><img src="/src/assets/twitter.png" alt="Twitter" className="w-6 h-6" /></a>
          </div>
